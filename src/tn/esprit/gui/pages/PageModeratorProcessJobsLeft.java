...
import static tn.esprit.gui.pages.PageModeratorProcessJobsRight.countPredicate;
import static tn.esprit.gui.pages.PageModeratorProcessJobsRight.gauge;
 ...
 * @author mdsaadlaoui
 */
public class PageModeratorProcessJobsLeft extends VBox {
    ...
    public PageModeratorProcessJobsLeft() {
        ...
        table.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                PageModeratorProcessJobsRight.jobTitle.setText(SELECTED_JOB.getTitle());
                PageModeratorProcessJobsRight.jobCategory.setText(SELECTED_JOB.getTitle());
                PageModeratorProcessJobsRight.jobDescription.setText(SELECTED_JOB.getTitle());
                PageModeratorProcessJobsRight.salary.setText(SELECTED_JOB.getSalary().toString());
                try {
