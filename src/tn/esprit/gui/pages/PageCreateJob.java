...
public class PageCreateJob extends AnchorPane {
            ...
            if (datePicker != null) {
                try {
                    ...
                    job = new Job.Builder()
                            ...
                            .salary(Double.valueOf(textField1.getText()))
                            .description(textArea.getText())
                            .location(textField2.getText())
                            .status(JobStatus.PENDING)
                            .expireDate(date)
                            .creationDate(new Date())
                            .company(serviceCompany.findByRecruter(App.USER_ONLINE))
                            .build();
                    serviceJob.create(job);
                    ((HBox) App.GLOBAL_PANE_BORDER.getCenter()).getChildren().remove(1);
